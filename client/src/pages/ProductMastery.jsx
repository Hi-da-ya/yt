        ...
        <div className="courses-grid">
          ...
          <div className="course-card course-card--featured">
            ...
            <p className="course-description">
              ...
              We’ll train you, coach you, and push you to think, talk, and act like a Product Manager.<br></br>
              We'll cover:
            </p>
          ...
          <div className="course-card">
            <div className="course-header">
              ...
              <div className="course-badge">Coming Soon</div>
            </div>
            ...
            <p className="course-description">
              ...
              all without writing a single line of code.<br></br>
              We'll cover:
            </p>
            <ul className="course-features">
          ...
          <div className="course-card">
            ...
            <p className="course-description">
              ...
              pitch like your dream depends on it (because it just might).<br></br>
              We'll cover:
            </p>
            <ul className="course-features">
