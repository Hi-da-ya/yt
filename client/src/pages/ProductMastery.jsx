  ...
  return (
    <div className="product-mastery-page">
      <div className="product-mastery-container">
        ...
        <div className="courses-grid">
          ...
          <div className="course-card course-card--featured">
              <div className="course-header">
                <div className="course-icon bg-gradient-to-br from-[#FF4FA3] to-[#212121]">
                  <svg className=" w-12 h-12" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M6.267 3.455a3.066 3.066 0 001.745-.723 3.066 3.066 0 013.976 0 3.066 3.066 0 001.745.723 3.066 3.066 0 012.812 2.812c.051.643.304 1.254.723 1.745a3.066 3.066 0 010 3.976 3.066 3.066 0 00-.723 1.745 3.066 3.066 0 01-2.812 2.812 3.066 3.066 0 00-1.745.723 3.066 3.066 0 01-3.976 0 3.066 3.066 0 00-1.745-.723 3.066 3.066 0 01-2.812-2.812 3.066 3.066 0 00-.723-1.745 3.066 3.066 0 010-3.976 3.066 3.066 0 00.723-1.745 3.066 3.066 0 012.812-2.812zm7.44 5.252a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  </svg>
                </div>
                <div className="course-badge bg-gradient-to-br from-[#FF4FA3] to-[#212121]">Featured</div>
              </div>
              ...
              <div className="flex gap-2 mb-6">
                <button 
                  className="flex-1 py-3 px-2 rounded-lg bg-gradient-to-br from-[#FF4FA3] to-[#212121] text-white font-semibold text-sm hover:shadow-lg hover:shadow-pink-500/30 hover:-translate-y-0.5 transition-all duration-200 transform text-center"
        ...
        {/* Final CTA */}
        <div className="py-20 bg-gradient-to-br from-[#FF4FA3] to-[#212121] text-white text-center">
          <h3 className="text-3xl md:text-4xl font-bold mb-5">Ready to Make the Jump?</h3>
          {/* <p>
          ...
          <button
            onClick={() => window.open('https://youngtechiez.carrd.co/', '_blank')}
